<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountPayPwd.aspx.cs" Inherits="AccountPayPwd" %>
            ...
            $("#dd").dialog({
                ...
                buttons: {
                    '确定': function () {
                        $(this).dialog('close');
                        if (t.indexOf("成功") != -1) {
                            //document.getElementById("lbtnTuiChu").click();
               ...
               <tr runat="server" id="trOldPwd">
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="OldPWD"
                            ErrorMessage="原支付密码不能为空" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td class="td">
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="NewPwd"
                            ErrorMessage="新支付密码不能为空" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator10" runat="server"
                            ControlToValidate="NewPwd" ErrorMessage="必须大于六位" ForeColor="Red" ValidationExpression="(\d|[a-z]|[A-Z]){6,}"
