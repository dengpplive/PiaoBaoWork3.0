<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SmsCpyGroup.aspx.cs" Inherits="SMS_SmsCpyGroup" %>
     ...
     <div class="container">
              <table border="0" cellpadding="0" cellspacing="0" class="Search">
                    <tr>
                        ...
                        <asp:Button ID="btsel" runat="server" Text="查询" onclick="btsel_Click"/></span>
                        </td>
                        </tr>
                        </table>
                        </div>
          <table id="tb-all-trade" class="tb-all-trade" width="100%" cellspacing="0" cellpadding="0" border="0">
                ...
                <asp:Repeater ID="Repeater" runat="server">
                    <ItemTemplate>
                      <tr onmouseover="this.bgColor='#F5F5F5';" onmouseout="this.bgColor='#ffffff';">
                            <td  class="Operation">
                                <input runat="server" name="cbItems" id='cbItem' type="checkbox" value='<%# Eval("ContactTel").ToString()%>'
            ...
            <div align="center">
              <span class="btn btn-ok-s">
            <asp:Button ID="btok" runat="server" Text="确定" onclick="btok_Click"/></span>&nbsp;
              <span class="btn btn-ok-s">
