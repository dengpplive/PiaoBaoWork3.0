<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LogErrorList.aspx.cs" Inherits="Logs_LogErrorList" %>
                ...
                <div class="container" style="padding-bottom: 10px;">
                    <table class="Search" cellspacing="0" cellpadding="0" border="0" style="border-collapse: collapse;">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtDevName" runat="server"></asp:TextBox>
                            </td>
                              <th>
                                记录时间：
                            </th>
                ...
                <asp:Repeater ID="repErrorList" runat="server">
                    <ItemTemplate>
                        <tr onmouseover="this.bgColor='#F5F5F5';" onmouseout="this.bgColor='#ffffff';">
                           ...
                           <%-- <td class="Operation">
                                <a href="BaseCabinEdit.aspx?Id=<%#Eval("id") %>">修改</a>
