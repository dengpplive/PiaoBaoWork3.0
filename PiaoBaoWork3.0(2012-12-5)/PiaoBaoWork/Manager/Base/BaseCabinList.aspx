<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BaseCabinList.aspx.cs" Inherits="Sys_BaseCabinList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#txtRebate").keyup(function () {
                if (!zz1.test($("#txtRebate").val())) {
                    $("#txtRebate").val("");
                }
            })
        })
                ...
                <div class="container" style="padding-bottom: 10px;">
                    <table class="Search" cellspacing="0" cellpadding="0" border="0" style="border-collapse: collapse;">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtRebate" runat="server"></asp:TextBox>
                            </td>
                    ...
                    <ItemTemplate>
                        <tr onmouseover="this.bgColor='#F5F5F5';" onmouseout="this.bgColor='#ffffff';">
                           ...
                           <td>
                            ...
                            <td>
                                <%#Eval("StartTime").ToString().Split(' ')[0]%>
                            </td>
                            <td>
                            ...
                            <td class="Operation">
                                <a href="BaseCabinEdit.aspx?Id=<%#Eval("id") %>&currentuserid=<%=this.mUser.id.ToString() %>">修改</a>
