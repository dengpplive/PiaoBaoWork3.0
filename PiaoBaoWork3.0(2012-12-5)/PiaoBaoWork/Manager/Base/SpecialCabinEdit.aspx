<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SpecialCabinEdit.aspx.cs" Inherits="Manager_Base_SpecialCabinEdit" %>
            ...
            <table width="100%" border="1" style="border-collapse: collapse;" cellpadding="0"
                ...
                <tr>
                    ...
                    <td class="alignLeft">
                        ...
                        <span id="spanCabin" style="color: Red;"><b>*</b></span>&nbsp;&nbsp;<span style="color: green;">多个特价舱位用"/"隔开 如:/A/B/C/D/</span>
                    </td>
                   <td class="td">
                        生效日期：
                    </td>
                ...
                <tr>
                    ...
                    <td class="alignLeft">
                        <asp:TextBox ID="txtAirCode" CssClass="txt" runat="server"  ReadOnly="true" onblur="showErr('txtAirCode','spanAirCode')" onkeyup="value=value.replace(/[^a-zA-Z0-9]/g,'')"></asp:TextBox>
