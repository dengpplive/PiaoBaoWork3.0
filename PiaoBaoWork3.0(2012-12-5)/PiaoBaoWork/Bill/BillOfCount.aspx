<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BillOfCount.aspx.cs" Inherits="Bill_BillOfCount" %>
...
<body>
    ...
    <div id="tabs">
        ...
        <div id="tabs-1">
                ...
                <table class="Search" cellspacing="0" cellpadding="0" border="0">
                    ...
                    <tr>
                       <td align="center" colspan="2">
                            <asp:CheckBox ID="showtf" runat="server" Text='显示退废票' />
                             <asp:CheckBox ID="cbType" Checked="true" runat="server" Text='显示退/废票费'/>
                             <asp:CheckBox ID="cbshowdf" runat="server" Text='显示本地代付'/>
                        </td>
                        <th id="thpolicy" runat="server">
                              政策来源：</th>
                        <td id="tdpolicy" runat="server">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="MoreConditionA" onclick="moreSearchOrder();" id="moreSearchOrderA" runat="server">
                        ...
                        <tr>
                            <td>
                                <asp:CheckBoxList ID="cblist" runat="server" RepeatDirection="Horizontal" RepeatColumns="12">
                                    ...
                                    <asp:ListItem Value="接口订单号">接口订单号</asp:ListItem>
                                    <asp:ListItem Value="机票状态">机票状态</asp:ListItem>
                                    <asp:ListItem Value="是否做过退废">是否做过退废</asp:ListItem>
                                    ...
                                    <asp:ListItem Value="退废改手续费">退废改手续费</asp:ListItem>
                                    ...
                                    <asp:ListItem Value="航空公司返点">航空公司返点</asp:ListItem>
                                    <asp:ListItem Value="是否收银">是否收银</asp:ListItem>
                                    <asp:ListItem Value="出票时间">出票时间</asp:ListItem>
                                    <asp:ListItem Value="退废改时间">退废改时间</asp:ListItem>
                                    <asp:ListItem Value="支付时间">支付时间</asp:ListItem>
                                    <asp:ListItem Value="航空公司退款金额">航空公司退款金额</asp:ListItem>
                                    ...
                                    <asp:ListItem Value="行程单号">行程单号</asp:ListItem>
            ...
            <div id="divTicketInfo" class="container" runat="server" style="width: 100%;">
                <table cellspacing="0" cellpadding="0" border="0" style="width: 100%;">
                    <tr>
                        <td>
                            <label runat="server" id="lal1" visible="false">
                                <strong style="color: #0C88BE;">机票信息汇总</strong></label>
                            <asp:LinkButton ID="lbtnDc1" runat="server" OnClick="lbtnDc1_Click" Visible="false">导出Excel</asp:LinkButton>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:GridView ID="gvTicketInfoCollect" Width="100%" runat="server" EmptyDataText="查无数据！" EnableViewState="false"
                                CssClass="tb-all-trade" AutoGenerateColumns="true" OnRowDataBound="gvTicketInfoCollect_RowDataBound">
                            </asp:GridView>
                             <div style="display: none;">
                                <asp:GridView ID="gvTicketInfoCollectNew" runat="server" CssClass="table1">
                                </asp:GridView>
                            </div>
                        </td>
                    </tr>
        ...
        <table cellspacing="0"  runat="server" id="divTicketSell" cellpadding="0" border="0" style="width: 2000px;">
                    <tr>
                        <td style="width: 100%;">
                            <label runat="server" id="lal2" visible="false">
                                <strong style="color: #0C88BE;">机票销售统计</strong></label>
                            <asp:LinkButton ID="lbtnDc2" runat="server" OnClick="lbtnDc2_Click" Visible="false">导出Excel</asp:LinkButton>
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 100%;">
                            <asp:GridView ID="gvTicketSellCount" runat="server" EmptyDataText="查无数据！"  CssClass="table1" Width="100%" EnableViewState="false"
                                AutoGenerateColumns="true" OnRowDataBound="gvTicketSellCount_RowDataBound">
                            </asp:GridView>
                            <div style="display: none;">
                                <asp:GridView ID="gvTicketSellCountNew" runat="server"  CssClass="table1">
                                </asp:GridView>
                            </div>
                        </td>
                    </tr>
        ...
        <tr>
            <td style="width: 100%;">
                <label runat="server" id="lal3" visible="false">
                    <strong style="color: #0C88BE;">机票信息明细</strong></label>
                <asp:LinkButton ID="lbtnDc3" runat="server" OnClick="lbtnDc3_Click" Visible="false">导出Excel</asp:LinkButton>
            </td>
        </tr>
        <tr>
            <td style="width: 100%;">
                <asp:GridView ID="gvTicketDetail" Width="100%" runat="server" OnRowDataBound="gvTicketDetail_RowDataBound" EnableViewState="false"
                    EmptyDataText="查无机票信息明细！" CssClass="tb-all-trade">
                </asp:GridView>
                <div style="display: none">
                    <asp:GridView ID="gvTicketDetailNew" Width="100%" runat="server" EmptyDataText="查无机票信息明细！" EnableViewState="false"
    ...
    <table style="width: 100%;" border="0" class="sugges">
        ...
        <tr>
            <td class="sugcontent">
                1.请使用IE浏览器导出报表。<br />
                2.机票状态为出票时：<br />
                  (不勾选显示退废票选项)只显示未做过退废票的出票数据<br />
                  (勾选显示退废票选项)显示出票以及已经做过退票的出票数据
