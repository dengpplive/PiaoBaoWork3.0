<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GetGXOrderCount.aspx.cs"
    Inherits="Bill_GetGXOrderCount" %>
            ...
            <div class="container">
                        ...
                        <td colspan="4">
                            <div align="right">
                                <span class="btn btn-ok-s">
                                    ...
                                    <asp:Button ID="btnClear" runat="server" Text="重置数据" ></asp:Button>
                                </span>
                            </div>
                        </td>
                    </tr>
                ...
                <div id="moreSearchOrder" class="container moreSearch" style="display: none;">
                    <table class="Search" cellspacing="0" cellpadding="0" border="0">
                        <tr>
                            <td>
                                <asp:CheckBoxList ID="cblist" runat="server" RepeatDirection="Horizontal" RepeatColumns="9">
                                    ...
                                    <asp:ListItem Value="现返">现返</asp:ListItem>
                                    <asp:ListItem Value="退改签手续费">退改签手续费</asp:ListItem>
                                    <asp:ListItem Value="在线交易手续费">在线交易手续费</asp:ListItem>
                                    <asp:ListItem Value="客户实付">客户实付</asp:ListItem>
                                    ...
                                    <asp:ListItem Value="采购金额">采购金额</asp:ListItem>
                                    <asp:ListItem Value="利润">利润</asp:ListItem>
                                    <asp:ListItem Value="采购科目">采购科目</asp:ListItem>
        ...
        <tr>
            <td style="width: 100%;">
                <label runat="server" id="lal3" visible="false">
                    <strong style="color: #0C88BE;">共享订单统计</strong></label>
                <asp:LinkButton ID="lbtnDc3" runat="server"  Visible="false">导出Excel</asp:LinkButton>
            </td>
        </tr>
        <tr>
            <td style="width: 100%;">
                <asp:GridView ID="gvTicketDetail" Width="100%" runat="server" EmptyDataText="查无机票信息明细！"
