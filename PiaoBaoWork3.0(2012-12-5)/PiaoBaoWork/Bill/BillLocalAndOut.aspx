<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BillLocalAndOut.aspx.cs" Inherits="Bill_BillLocalAndOut" %>
...
<body>
    ...
    <div id="tabs">
        <div class="title">
            <span id="lblShow" runat="server"></span>
        </div>
        <div id="tabs-1">
            <div class="container">
                    ...
                    <tr>
                        ...
                        <td align="center">
                            ...
                            <asp:CheckBox ID="showtf" runat="server" Text='显示退废票' />
                             <asp:CheckBox ID="cbType" runat="server" Checked="true" Text='显示退/废票费'/>
