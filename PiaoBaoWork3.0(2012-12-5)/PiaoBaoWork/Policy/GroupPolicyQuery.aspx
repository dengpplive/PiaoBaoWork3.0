<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GroupPolicyQuery.aspx.cs"
    Inherits="Policy_GroupPolicyQuery" %>
...
<head id="Head1" runat="server">
    <title id="tleName" runat="server">散冲团政策查看</title>
    ...
    <div class="container">
        <table class="Search" cellspacing="0" cellpadding="0" border="0">
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList runat="server" ID="ddlPolicyType" Width="155px">
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList runat="server" ID="ddlPriceType" Style="width: 155px;">
                        <asp:ListItem Value="-1" Text="全部" Selected="True"></asp:ListItem>
        ...
        <asp:Repeater ID="Repeater" runat="server" OnPreRender="Repeater_PreRender" OnItemCommand="Repeater_ItemCommand">
            <ItemTemplate>
                <tr id="tr_item<%#Eval("Id") %>" onmouseout="this.bgColor='#ffffff';" onmouseover="this.bgColor='#F5F5F5';">
                    <td>
                        <%# ShowItem(5, Eval("Id"), Eval("CpyNo"))%>
                    </td>
                    <%-- <td class="tdw100" title='<%# ShowItem(11, Eval("CpyNo")) %>'>                       
                        <%#SubChar(ShowItem(4, Eval("CpyNo")),20,"...")%>
                    </td>--%>
                    <td>
                    ...
                    <td>
                        <ul class="ulClass">
                            ...
                            <li>政策类型:<%# ShowItem(2,Eval("PolicyType"))%></li>
                            <li><span id='show_youhui_<%#Eval("Id") %>'>优惠<%# ((Eval("PriceType").ToString() == "1" || Eval("PriceType").ToString().ToLower() == "true")?"价格:":"折扣:")+ShowItem(3, Eval("PriceType"), Eval("Rebate"), Eval("Prices"))%>
                            </span><span id='hide_youhui_<%#Eval("Id") %>' class="hide">优惠<%# (Eval("PriceType").ToString() == "1" || Eval("PriceType").ToString().ToLower() == "true")?"价格":"折扣"%>
                                <input type="text" id='txtyouhui_<%#Eval("Id") %>' value='<%# ShowItem(3, Eval("PriceType"), Eval("Rebate"), Eval("Prices"))%>'
                                    size="4" />
                            </span></li>
                        </ul>
                    </td>
