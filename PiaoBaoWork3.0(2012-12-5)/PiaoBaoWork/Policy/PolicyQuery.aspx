<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PolicyQuery.aspx.cs" Inherits="Policy_PolicyQuery" %>
...
<head id="Head1" runat="server">
    <title id="tleName" runat="server">政策查看</title>
        ...
        */
        ...
        function ajaxUpdate(id,opType) {
            ...
            jQueryOne.post("../AJAX/CommonAjAx.ashx",
            {
                ...
                OpPage: escape("PolicyQuery.aspx"),
                //Copy: escape(IsCopy),
                Id: escape(id),
                num: Math.random(),
...
<body>
    ...
    <div class="title" style="width: 99%">
        <ul style="list-style-type: none; margin: 0 0; padding: 0 0; position: relative;
            width: 99%">
            <li>
                <asp:Label ID="lblShow" Text="政策查看" runat="server" />
            </li>
        </ul>
    </div>
    <div id="div_tab1" runat="server">
        <div class="container">
            <table class="Search" cellspacing="0" cellpadding="0" border="0">
                ...
                <tr class="show">
                    ...
                    <td>
                        <asp:DropDownList runat="server" ID="rblTravelType" Style="width: 155px;">
                ...
                <tr class="show">
                    ...
                    <td>
                        <asp:DropDownList runat="server" ID="ddlPolicyType" Style="width: 155px;">
                    ...
                    <th>
                        <span class='<%=PageType=="3"?"show":"hide" %>'>乘客类型：</span>
                    </th>
                    <td colspan="2">
                        <span class='<%=PageType=="3"?"show":"hide" %>'>
                            <asp:DropDownList runat="server" ID="ddlPasType" Width="155px">
                                <asp:ListItem Value="0" Text="全部" Selected="True"></asp:ListItem>
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <asp:TextBox ID="txtSpace" runat="server" MaxLength="200"></asp:TextBox>
                    </td>
                    <th>
                        适用航班号：
                    </th>
                    <td>
                        <asp:TextBox ID="txtFlightNo" runat="server" MaxLength="500"></asp:TextBox>
                    </td>
                    <th>
                    </th>
                    <td>
        ...
        <div class="c-list-filter-go">
            <table cellspacing="0" cellpadding="0" border="0" width="90%" align="center" style="margin-left: -200px;">
                <tbody>
                    <tr>
        ...
        <asp:Repeater ID="Repeater" runat="server" OnPreRender="Repeater_PreRender" OnItemCommand="Repeater_ItemCommand">
            <ItemTemplate>
                <tr id="tr_item<%#Eval("Id") %>" onmouseout="this.bgColor='#ffffff';" onmouseover="this.bgColor='#F5F5F5';">
                    <td>
                        <%--操作--%>
                        <%# ShowItem(10, Eval("Id"), Eval("CpyNo"))%>
                    </td>
                    <%--   <td class="tdw100" title='<%# ShowItem(11, Eval("CpyNo")) %>'>                       
                        <%#SubChar(ShowItem(11, Eval("CpyNo")),20,"...")%>
                    </td>--%>
                    <td>
