    ...
    public class PatInfo
    {
        ...
        public override string ToString()
        {
            ...
            sbPat.AppendFormat("{0} {1} FARE:CNY{2} TAX:CNY{3} YQ:CNY{4}  TOTAL:{5} \r",
                ...
                this.SeatGroup,
                this.Fare.IndexOf(".0") != -1 ? this.Fare : this.Fare + ".00",
                this.TAX.IndexOf(".0") != -1 ? this.TAX : this.TAX + ".00",
                this.RQFare.IndexOf(".0") != -1 ? this.RQFare : this.RQFare + ".00",
                this.Price.IndexOf(".0") != -1 ? this.Price : this.Price + ".00"
                );
            sbPat.Append(this.SFC);
