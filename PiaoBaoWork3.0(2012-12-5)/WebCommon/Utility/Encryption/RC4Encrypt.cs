...
namespace PbProject.WebCommon.Utility.Encryption
{
    public class RC4Encrypt
    {
        ...
        /// </summary>
        static public System.Text.Encoding Encode = System.Text.Encoding.Default;
        ...
        public String Encrypt(String data, String pass, RC4Encrypt.EncoderMode em)
        {
        ...
        /// <param name="em">编码模式</param>
        /// <returns>明文</returns>
        public String Decrypt(String data, String pass, RC4Encrypt.EncoderMode em)
        {
            if (data == null || pass == null) return null;
            if (em == EncoderMode.Base64Encoder)
        ...
        /// <returns>密文</returns>
        private Byte[] EncryptEx(Byte[] data, String pass)
        {
            if (data == null || pass == null) return null;
        ...
        /// <param name="pass">密码</param>
        /// <returns>明文</returns>
        private Byte[] DecryptEx(Byte[] data, String pass)
        {
