...
namespace PbProject.Cache
{
    ...
    /// 业务数据缓存B
    /// </summary>
    public class MemcacheBusinessB : IMemcacheAgent
    {
        private static MemcacheBusinessB instance;
        private static MemcachedClient mc;
        public MemcacheBusinessB()
        {
            string[] serverlist = { CacheServerDefines.BUSINESSCACHESERVER_B };
            SockIOPool pool = SockIOPool.GetInstance(CacheServerDefines.BUSINESSCACHESERVERNAME_B);
        ...
        private static void InitMemcacheClient()
        {
            ...
            mc.PoolName = CacheServerDefines.BUSINESSCACHESERVERNAME_B;
            mc.EnableCompression = false;
        }
        public static MemcacheBusinessB GetInstance() 
        {
            if (instance == null)
                instance = new MemcacheBusinessB();
            if (mc == null)
                InitMemcacheClient();
            return instance;
        }
