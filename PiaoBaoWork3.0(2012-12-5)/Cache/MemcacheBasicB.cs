...
namespace PbProject.Cache
{
    ...
    /// 基础数据缓存B
    /// </summary>
    public class MemcacheBasicB : IMemcacheAgent
    {
        private static MemcacheBasicB instance;
        private static MemcachedClient mc;
        public MemcacheBasicB()
        {
            string[] serverlist = { CacheServerDefines.BASICCACHESERVER_B };
            SockIOPool pool = SockIOPool.GetInstance(CacheServerDefines.BASICCACHESERVERNAME_B);
        ...
        private static void InitMemcacheClient()
        {
            ...
            mc.PoolName = CacheServerDefines.BASICCACHESERVERNAME_B;
            mc.EnableCompression = false;
        }
        public static MemcacheBasicB GetInstance()
        {
            if (instance == null)
                instance = new MemcacheBasicB();
            if (mc == null)
                InitMemcacheClient();
            return instance;
        }
