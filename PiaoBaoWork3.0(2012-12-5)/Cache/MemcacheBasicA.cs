...
namespace PbProject.Cache
{
    ...
    /// 基础数据缓存A
    /// </summary>
    public class MemcacheBasicA : IMemcacheAgent
    {
        private static MemcacheBasicA instance;
        private static MemcachedClient mc;
        public MemcacheBasicA()
        {
            string[] serverlist = { CacheServerDefines.BASICCACHESERVER_A };
            SockIOPool pool = SockIOPool.GetInstance(CacheServerDefines.BASECCACHESERVERNAME_A);
        ...
        private static void InitMemcacheClient()
        {
            ...
            mc.PoolName = CacheServerDefines.BASECCACHESERVERNAME_A;
